...
plotPlaid(files[3], first=expanded1, second=expanded2, max.count=cap.scaled[2],width=5e4, param=hs.param, main="MB1")
```
...
rotPlaid(files[3], hs.param, region=chosen.r, width=5e4, main="MB1", max.count=cap.scaled[2])
```
...
plotPlaid(files[3], first=chrom12, second=chrom12, max.count=cap.scaled[2],
